...
var eslint = new eslint_1.ESLint({
    ...
    resolvePluginsRelativeTo: (0, utils_1.getCwdPath)('node_modules') // 指定 loader 加载路径
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, utils_1.loggerTiming)('Eslint 校验');
                    return [4 /*yield*/, eslint.lintFiles([(0, utils_1.getCwdPath)(path)])
                ...
                case 4:
                    ...
                    return [3 /*break*/, 6];
                case 5:
                    (0, utils_1.loggerTiming)('Eslint 校验', false);
                    return [7 /*endfinally*/];
